...
<body data-spy="scroll" data-offset="0" data-target="#navbar-main">
		...
		<br><br><br><br>
			<?php
				echo "<div class = 'container-fluid' style =' border-radius: 25px;border: 2px solid #73AD21;'>";
					echo validation_errors();
					echo form_open("ctBase/createcmd");
					echo "<div><b>Comment Here</div><br>";
					echo form_hidden("txtid",$ID_artikel);
					echo "<textarea name='txtcmd'></textarea>";
					...
					if($allcmd =!= null ){
						...
						echo "<div align = 'center'>";
							...
							echo '<div align = "center" id="commend'.$ctr++.'" style="font-size:14px; left:20%;width: 60%; border: 1px solid black;padding:1%; ">';
